...
static const _CenterAndArea_type_support_symbol_names_t _CenterAndArea_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, integ_my_robot_interfaces, msg, CenterAndArea)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, integ_my_robot_interfaces, msg, CenterAndArea)),
  }
};
...
{
  return &::integ_my_robot_interfaces::msg::rosidl_typesupport_cpp::CenterAndArea_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, integ_my_robot_interfaces, msg, CenterAndArea)() {
  return get_message_type_support_handle<integ_my_robot_interfaces::msg::CenterAndArea>();
}
