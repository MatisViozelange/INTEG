...
class Init_CenterAndArea_detected
{
public:
  explicit Init_CenterAndArea_detected(::integ_my_robot_interfaces::msg::CenterAndArea & msg)
  : msg_(msg)
  {}
  ::integ_my_robot_interfaces::msg::CenterAndArea detected(::integ_my_robot_interfaces::msg::CenterAndArea::_detected_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_CenterAndArea_detected area(::integ_my_robot_interfaces::msg::CenterAndArea::_area_type arg)
  {
    msg_.area = std::move(arg);
    return Init_CenterAndArea_detected(msg_);
  }
