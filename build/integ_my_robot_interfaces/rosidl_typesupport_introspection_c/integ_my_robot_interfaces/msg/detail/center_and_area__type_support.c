...
static rosidl_typesupport_introspection_c__MessageMember integ_my_robot_interfaces__msg__CenterAndArea__rosidl_typesupport_introspection_c__CenterAndArea_message_member_array[3] = {
  {
    "center",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(integ_my_robot_interfaces__msg__CenterAndArea, detected),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
